...
async def json_css_product_extraction():
    ...
    # internal_links =await  product_links_extraction()
    all_data = []
    load_dotenv()
    base_url = "https://vn.misumi-ec.com/vona2/detail/110302555550/?list=PageCategory"
    ...
    initial_run_config = CrawlerRunConfig(
            ...
            """,
            wait_for = "css:div#deTabsContainer"
        ...
        # for link in internal_links:
            ...
            for i in range(1,3):
                ...
                js_code="""
                    ...
                    const nextButton = document.querySelector('div.Pagination_container__VOa4I:nth-of-type(2) > li:nth-child(2) > a');
                    if(nextButton){
                        nextButton.click();
