...
def parse_html_result(result):
    ...
    **Product URL:** <{result.url}>
    ...
    {specs_text}
    """
    print("--- CLEAN MARKDOWN GENERATED ---")
    print(clean_markdown)

    # 4. Save the clean markdown to a file
    with open("product-details-clean.md", "w", encoding="utf-8") as f:
        f.write(clean_markdown)
    print("\n--- Successfully saved to product-details-clean.md ---")
